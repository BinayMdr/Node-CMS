...
const Profile = (props) => {
  ...
  const handleLogout = async () => {
    ...
    dispatch(addBranchData({ branchData: null }))
    navigate('/login')
  };
    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center" sx={{ p: 0.5 }}>
          <Typography variant="subtitle1"> {userDetails.userData?.name } </Typography>
        </Stack>
      </ButtonBase>
      <Popper
                      ...
                      <Grid container justifyContent="space-between" alignItems="center">
                        <Grid item>
                          <Stack direction="row" spacing={1.25} alignItems="center">
                            ...
                            <Stack>
                              <Typography variant="h6">{ userDetails.userData?.name } </Typography>
                            </Stack>
                          </Stack>
                        </Grid>
                        <Grid item>
