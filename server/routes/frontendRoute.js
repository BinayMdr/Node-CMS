...
const {getAboutUs,getAllGlobalSetting,getGalleryFiles,getHomePage,getBanner,getCustomerReview,getMenu,storeMessage,getFoodItem} = require("../controllers/FrontendController");
...
router.get('/get-food-item',getFoodItem)
