...
const {getAllProduct,storeProduct,updateProduct,getProduct,getProductList,getProductVariation,getProductFromBranch} = require("../controllers/ProductController");
...
router.get('/get-variation/:productId/branch/:branchId',tokenVerifyMiddeware,getProductVariation)
